...
function(declare, lang, array, html, BaseWidget, on, aspect, string,
  SpatialReference, ImageNode, TileLayoutContainer, store) {
  return declare([BaseWidget], {
    ...
    _setCamera: function(bookmark){
      require(['jimu/utils3d'], lang.hitch(this, function(utils3d){
        this.map.setCamera(utils3d.getCameraFromArray(bookmark.camera), this.config.flyTime);
      }));
    }
