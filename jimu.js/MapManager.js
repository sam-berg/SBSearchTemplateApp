...
], function(declare, lang, array, html, topic, on, aspect, agolUtils, InfoWindow, PopupMobile, InfoTemplate, esriRequest, SpatialReference,
  Extent, require, portalUrlUtils, utils, LoadingShelter) {
  /* global jimuConfig */
  var instance = null,
    clazz = declare(null, {
      appConfig: null,
