        ...
        .then(lang.hitch(this, function(results){
          ...
          this.loadWidgetResources(setting).then(lang.hitch(this, function(resouces){
            try{
              ...
              new Message({message: 'create widget error: ' + setting.uri});
              def.reject(err);
            }
      ...
      then(lang.hitch(this, function(results) {
        ...
        this.loadWidgetSettingPageResources(setting).then(lang.hitch(this, function(resources){
          ...
          try{
            ...
            new Message({message: 'Create widget setting page error:' + setting.uri});
            def.reject(err);
          }
        }), function(err){
          console.log(err);
    ...
    _tryLoadResource: function(setting, flag){
      ...
      doLoad = function(){
        ...
        loadDef.then(function(data){
          ...
          new Message({message: 'load widget resouce error: ' + setting.uri});
          def.reject(err);
        });
      };
