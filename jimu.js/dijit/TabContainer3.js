  ...
  return declare([_WidgetBase, _TemplatedMixin, Evented], {
    ...
    postCreate: function(){
      ...
      if(this.average){
        ...
        var strTabItemTd = '<td class="tab-item-td" style="border-bottom:1px solid #ccc;"><div class="tab-item-div"></div></td>';
    ...
    _createTab:function(tabConfig){
      var strTabItemTd = '<td class="tab-item-td"><div class="tab-item-div"></div></td>';
      var tabItemTd = html.toDom(strTabItemTd);
      ...
      this.own(on(tabItemTd,'click',lang.hitch(this,this.onSelect,tabConfig.title)));
    },
